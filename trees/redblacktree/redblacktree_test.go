...
func transform[T any](f func(v T) string, values ...T) (res []string) {
...
func ints2str(i ...int) string {
	return strings.Join(transform(strconv.Itoa, i...), "")
}

func strs2str(s ...string) string {
	return strings.Join(s, "")
}

type keyValFound struct {
	key   int
	val   string
	found bool
}
...
func TestRedBlackTreePut(t *testing.T) {
	...
	if actualValue, expectedValue := ints2str(tree.Keys()...), "1234567"; actualValue != expectedValue {
		t.Errorf("Got %v expected %v", actualValue, expectedValue)
	}
	if actualValue, expectedValue := strs2str(tree.Values()...), "abcdefg"; actualValue != expectedValue {
		t.Errorf("Got %v expected %v", actualValue, expectedValue)
	}
...
func TestRedBlackTreeRemove(t *testing.T) {
	...
	if actualValue, expectedValue := ints2str(tree.Keys()...), "1234"; actualValue != expectedValue {
		t.Errorf("Got %v expected %v", actualValue, expectedValue)
	}
	if actualValue, expectedValue := strs2str(tree.Values()...), "abcd"; actualValue != expectedValue {
		t.Errorf("Got %v expected %v", actualValue, expectedValue)
	}
	if actualValue, expectedValue := strs2str(tree.Values()...), "abcd"; actualValue != expectedValue {
		t.Errorf("Got %v expected %v", actualValue, expectedValue)
	...
	if actualValue, expectedValue := ints2str(tree.Keys()...), ""; actualValue != expectedValue {
		t.Errorf("Got %v expected %v", actualValue, expectedValue)
	}
	if actualValue, expectedValue := strs2str(tree.Values()...), ""; actualValue != expectedValue {
		t.Errorf("Got %v expected %v", actualValue, expectedValue)
	}
